...
| Path                                                           | Description                                                                                                          |
| -------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| **[📂 rhdh-product-docs](./rhdh-product-docs-1.10-Jul17-2026)** | The Red Hat Developer Hub (RHDH) product documentation (v1.10) used as the source knowledge base for this evaluation. |
...
- **Source Material:** The dataset is derived entirely from the [RHDH 1.10 Product Docs](./rhdh-product-docs-1.10-Jul17-2026).
